...
package twitter.api {
	...
	public class Twitter extends EventDispatcher
	{
		...
		private static const LOAD_FRIENDS_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/friends/$userId.xml";
		private static const LOAD_FRIENDS_TIMELINE_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/friends_timeline/$userId.xml";
		private static const PUBLIC_TIMELINE_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/public_timeline.xml"
		private static const LOAD_USER_TIMELINE_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/user_timeline/$userId.xml?" + 
			"count=$count&page=$page"
		private static const FOLLOW_USER_URL:String = 
			"http://twitter.proxy.jamesward.com/friendships/create/$userId.xml";
		private static const SET_STATUS_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/update.xml";
		private static const SHOW_STATUS_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/show/$id.xml";
		private static const REPLIES_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/replies.xml";
		private static const DESTROY_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/destroy/$id.xml";
		private static const FOLLOWERS_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/followers.xml";
		private static const FEATURED_USERS_URL:String = 
			"http://twitter.proxy.jamesward.com/statuses/featured.xml";
		private static const GET_DIRECT_MSGS_URL:String = 
			"http://twitter.proxy.jamesward.com/direct_messages.xml?";
		private static const SEND_DIRECT_MSG_URL:String = 
			"http://twitter.proxy.jamesward.com/direct_messages/new.xml";
		private static const SEARCH_URL:String = 
			"http://search.twitter.com/search.atom?";
		private static const VERIFY_URL:String = 
			"http://twitter.proxy.jamesward.com/account/verify_credentials.xml";
		private static const UPDATE_LOCATON_URL:String = 
			"http://twitter.proxy.jamesward.com/account/update_location";
		private static const RATE_LIMIT_STATUS_URL:String = 
			"http://twitter.proxy.jamesward.com/account/rate_limit_status.xml";
		private static const END_SESSION_URL:String = 
			"http://twitter.proxy.jamesward.com/account/end_session.xml";
		private static const GET_SENT_DIRECT_MESSAGE_URL:String = 
			"http://twitter.proxy.jamesward.com/direct_messages/sent.xml";
		private static const SHOW_INFO_URL:String = 
			"http://twitter.proxy.jamesward.com/users/show/${id}.xml";
		private static const FRIENDS_IDS_URL:String = 
			"http://twitter.proxy.jamesward.com/friends/ids/${id}.xml";
		private static const FOLLOWERS_IDS_URL:String = 
			"http://twitter.proxy.jamesward.com/followers/ids/${id}.xml";
